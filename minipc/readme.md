...
| `immich` | immich-server | 2283 | Backup de fotos/vídeos — Google Photos (ML desabilitado) |
| `adguard` | adguard/adguardhome | 3001 (UI), 53 (DNS) | Bloqueador de anúncios via DNS |
| `vaultwarden` | vaultwarden/server | — | Gerenciador de senhas Bitwarden-compat |
